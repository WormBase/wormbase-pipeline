...
jbrowse_log_dir = os.path.join(PARASITE_SCRATCH,"log","jbrowse_webdata_deploy")
...
for js in jbrowse_species:
    dcommand = "module load embassy;\n\n" + \
               EMBASSY_COMMAND + " s3 sync " + os.path.join(PARASITE_SCRATCH,"jbrowse","WBPS"+PARASITE_VERSION,"out",js) + " " +\
               os.path.join(EMBASSY_PATH,"web_data/jbrowse/releases/release-"+PARASITE_VERSION,"data",js) +\
