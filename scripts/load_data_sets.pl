...
# Last updated on: $Date: 2007-10-02 08:28:40 $      
...
sub parse_misc_files {
  my %files_to_load = (
		       ...
		       $wormbase->misc_dynamic."/WS180_refseq.ace"              =>  'refseq_IDs'           ,
		       ...
		       $wormbase->misc_dynamic.'/misc_mtce_protein_IDs.ace'     => 'mtce_protein_IDs'      ,
