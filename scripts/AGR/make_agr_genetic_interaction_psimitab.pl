...
$interactorType{TABAll_suppressingTAB}{Effector}                      = 'psi-mi:"MI:0582"(suppressed gene)';
...
$interactorType{TABSub_suppressingTAB}{Effector}                      = 'psi-mi:"MI:0582"(suppressed gene)';
...
$interactorType{TABSuper_suppressingTAB}{Effector}                    = 'psi-mi:"MI:0582"(suppressed gene)';
$interactorType{TABSuper_suppressingTAB}{Affected}                    = 'alliance:suppressed interactor';
$interactorType{TABSuppressingTAB}{Effector}                          = 'psi-mi:"MI:0582"(suppressed gene)';
...
$interactorType{Mono_phenotypicTABAll_suppressingTAB}{Effector}       = 'psi-mi:"MI:0582"(suppressed gene)';
...
$interactorType{Mono_phenotypicTABSub_suppressingTAB}{Effector}       = 'psi-mi:"MI:0582"(suppressed gene)';
$interactorType{Mono_phenotypicTABSub_suppressingTAB}{Affected}       = 'alliance:suppressed interactor';
$interactorType{Mono_phenotypicTABSuppressingTAB}{Effector}           = 'psi-mi:"MI:0582"(suppressed gene)';
