...
# Last updated on: $Date: 2010-07-14 15:08:20 $
...
my $locus_2_gmap=<<EOF;
  Table-maker -p "/nfs/wormpub/DATABASES/geneace/wquery/locus_2_gmap.def" quit
EOF
...
my $rearr_ends=<<EOF;
  Table-maker -p "/nfs/wormpub/DATABASES/geneace/wquery/rearr_L_R_ends.def" quit
EOF
