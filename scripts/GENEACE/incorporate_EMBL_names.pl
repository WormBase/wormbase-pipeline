...
# Last updated on: $Date: 2010-07-14 15:15:25 $ 
...
my $output_dir = "/nfs/wormpub/DATABASES/geneace/EMBL_GENE_NAMES/";
my $temp_dir   = "/nfs/wormpub/DATABASES/geneace/EMBL_GENE_NAMES/TEMP/";
