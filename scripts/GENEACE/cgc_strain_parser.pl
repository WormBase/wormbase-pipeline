...
# Last updated on: $Date: 2012-06-22 10:21:46 $
...
system("wget -O $input_file https://www.cbs.umn.edu/sites/default/files/public/downloads/celelist_2.txt") && die "Unable to download strain data file from CGC website\n\n";
