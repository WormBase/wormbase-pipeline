...
# Last updated on: $Date: 2012-11-13 11:04:08 $
...
system("wget --no-check-certificate -O $input_file https://www.cbs.umn.edu/sites/default/files/public/downloads/celelist2.txt") && die "Unable to download strain data file from CGC website\n\n";
