...
# Last change by $Author: mh6 $ on $Date: 2014-05-07 08:35:36 $
...
GetOptions (
  ...
  "test"          => \$test,    # run against the test database on mcs11
...
$DB = $wormbase->test ? 'test_wbgene_id;mcs11:3307' : 'wbgene_id;shap:3303';
