...
# Last updated on: $Date: 2012-11-05 17:25:02 $      
...
`fasta2gsi.pl -f /lustre/scratch109/ensembl/wormpipe/swall_data/slimswissprot`
`cp /lustre/scratch109/ensembl/wormpipe/swall_data/slimswissprot ~/BlastDB/slimswissprot$ver.pep`
