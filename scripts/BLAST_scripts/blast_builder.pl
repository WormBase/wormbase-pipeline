...
# Last updated on: $Date: 2009-02-13 11:49:48 $      
...
sub dump {
  ...
  my $sort_dir = "/lustre/work1/ensembl/wormpipe/sort_dump";
  ...
  chdir "/lustre/work1/ensembl/wormpipe/sort_dump";
...
sub blastp_dump {
  ...
  $spDB->run_command('rm -f /lustre/work1/ensembl/wormpipe/sort_dump/junk*.*', $log);
