...
sub process_trembl {
  ...
  if ($okay) {
    ...
    $wormbase->run_command("/software/worm/perl_514/bin/perl BLAST_scripts/blast_kill_list.pl -infile $swalldir/slimtrembl -outfile $blastdir/slimtrembl${ver}.pep -killfile $swalldir/kill_list.txt",$log);
