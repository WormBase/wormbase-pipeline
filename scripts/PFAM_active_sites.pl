...
sub update_database {
  ...
  foreach my $table (@tables){
    ...
    my $ftp_folder = $pfam_release eq 'current_release' ? "/pub/databases/Pfam/current_release/database_files" : "/pub/databases/Pfam/releases/$pfam_release/database_files";
