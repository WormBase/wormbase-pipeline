...
our @tier3_organisms=qw(Mhapla Mincognita Heterorhabditis Hcontortus Hcontortus_gasser Cangaria Tspiralis Sratti Csp11 Asuum Bxylophilus Csp5 Loaloa Asuum_davis);
our @provisional_organisms = qw(Hcontortus);
...
sub mail_maintainer {
  ...
  $maintainer = "pad\@sanger.ac.uk,  gw3\@sanger.ac.uk, mh6\@sanger.ac.uk, mt3\@sanger.ac.uk klh\@sanger.ac.uk"    if ( $maintainer =~ m/All/i );
