...
my %mapping = (
  ...
  brepepp        => 'wormbase_id',
  brigpepp       => 'wormbase_id',
  ppapepp        => 'wormbase_id',  
  remaneip       => 'wormbase_id',
  wormpepp       => 'wormbase_id', 
  jappepp        => 'wormbase_id',  
  ipi_humanp     => 'IPI',
  gadflyp        => 'gadfly_translation_cgid',
  yeastp         => 'SGD',  
  slimswissprotp => 'Uniprot/SWISSPROT',
  slimtremblp    => 'Uniprot/SPTREMBL',
