...
my $dbnumber = &get_wormbase_version;
...
open (OUT,    ">/wormsrv2/autoace/mappings/RNAi_mappings.$dbnumber");
open (OUTACE, ">/wormsrv2/autoace/mappings/RNAi_mappings.$dbnumber.ace");
