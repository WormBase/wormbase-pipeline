...
# Last edited on: $Date: 2004-11-17 12:08:59 $
...
if( $prep_dump ) {
  ...
  if( -e "/wormsrv2/autoace/CHROMOSOMES/CHROMOSOME_X.gff") {
    ...
    &run_command("cp /wormsrv2/autoace/COMMON_DATA/clonesize.dat /nfs/disk100/wormpub/autoace/COMMON_DATA/") or die "ERROR: failed to copy clonesize.dat to ~wormpub/autoace/COMMON_DATA, this is required by dump_TRF.pl later on.\n";
